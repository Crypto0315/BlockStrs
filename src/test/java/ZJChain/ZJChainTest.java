...
import static ZJChain.Wallet.n;
import static ZJChain.Wallet.q;
...
public class ZJChainTest {
    ...
    public void test2() {
       ...
       // Security.addProvider(new org.bouncycastle.jce.provider.BouncyCastleProvider()); //Setup Bouncey castle as a Security Provider
        ...
        ZJChain.genesisTransaction = new Transaction(coinBase.strsPublicKey, walletA.strsPublicKey, 100f, null,coinBase);
        //生成coinbase对此次交易的签名   //function [C, z1, z2, theta, t0, h0] = signature(n, q, h, f, Lpk, miu, s1, s2)
        ZJChain.genesisTransaction.generateSignature(n,q,coinBase.H,coinBase.F,coinBase.PKS,coinBase.LPK,coinBase.mius,coinBase.strsPrivateKey1,coinBase.strsPrivateKey2);
        //ZJChain.genesisTransaction.generateSignature(coinBase);
        //初始交易id设为0
        ...
        ZJChain.genesisTransaction.outputs.add(new TransactionOutput(
                ZJChain.genesisTransaction.strsrecipient,
        ...
        //添加交易
        genesis.addTransaction(ZJChain.genesisTransaction,coinBase);
        //将该块加入区块链中
        ...
        block1.addTransaction(walletA.sendFunds(walletB.strsPublicKey, 20f,walletA),walletA);
