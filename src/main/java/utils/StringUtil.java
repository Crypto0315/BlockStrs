...
public class StringUtil {
   ...
   /* public static String getStringFromKey(Key key) {
     ...
     * @return
     */
    public static String getStringFromKey(Long[] array) {
        // Convert the Long[] array to a byte array
        byte[] byteArray = new byte[array.length * 8]; // 8 bytes per Long
        for (int i = 0; i < array.length; i++) {
            long value = array[i];
            byteArray[i * 8 + 0] = (byte) (value >> 56);
            byteArray[i * 8 + 1] = (byte) (value >> 48);
            byteArray[i * 8 + 2] = (byte) (value >> 40);
            byteArray[i * 8 + 3] = (byte) (value >> 32);
            byteArray[i * 8 + 4] = (byte) (value >> 24);
            byteArray[i * 8 + 5] = (byte) (value >> 16);
            byteArray[i * 8 + 6] = (byte) (value >> 8);
            byteArray[i * 8 + 7] = (byte) value;
        }
